...
public class InserzioniUI extends JFrame {
	...
	public InserzioniUI() {
		...
		dtm.setColumnIdentifiers(new String[]{"Inserzione", "Titolo", "Descrizione", "Prezzo per notte", "Numero persone", "Data inizio", "Data fine", "Struttura turistica", "Inserzionista"});
